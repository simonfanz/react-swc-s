...
const DeclinedReasons = () => {
  const [reasons, setReasons] = useState<DeclinedReason[]>([
    {
      id: "1",
      code: "DC-LATE",
      description: "Claim submitted after validity period",
      active: true,
    },
    {
      id: "2",
    ...
    },
    {
      id: "3",
      code: "DC-NOPRF",
      description: "Insufficient proof provided",
      active: true,
    },
    {
      id: "4",
  ...
  const [currentReason, setCurrentReason] = useState<DeclinedReason | null>(
    null,
  );
  ...
  const openEditDialog = (reason: DeclinedReason) => {
  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <h2 className="text-lg font-medium">Declined Reasons</h2>
        <Dialog open={isAddDialogOpen} onOpenChange={setIsAddDialogOpen}>
          ...
          <DialogContent>
            <DialogHeader>
              <DialogTitle>Add Declined Reason</DialogTitle>
              <DialogDescription>
                Create a new declined reason code for claims.
              </DialogDescription>
            </DialogHeader>
      ...
      <Dialog open={isEditDialogOpen} onOpenChange={setIsEditDialogOpen}>
        <DialogContent>
          <DialogHeader>
            <DialogTitle>Edit Declined Reason</DialogTitle>
            <DialogDescription>
              Modify the declined reason details.
            </DialogDescription>
          </DialogHeader>
          {currentReason && (
            <div className="grid gap-4 py-4">
